    ...
    return (
        <div className=' shadow p-5 mb-3 flex gap-10 items-center'>
            ...
            <div className='mb:w-1/6'>
                <button
                    type='button'
                    className=' bg-sky-700 gap-2 flex px-5 py-2 text-white rounded-md font-bold uppercase shadow-md w-full text-center'
